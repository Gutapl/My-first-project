...
while truea != 1: # соблюдает ли слово нужные нам условия
    a = input('Здравствуйте, сегодня сыграем в виселицу загадайте русское слово:') #проверка на правильность ввода
    a = a.lower()
    for i in a:
...
print("Вы не можете угадать несколько букв, вы можете угадать слово целиком или угадывать по ОДНОЙ букве")
...
while count != 0:
    ...
    if (b == a) and (len(b) > 1):# проверка на правильность всей строки
        ...
        print('!"!Never" команда показывающая неправильные буквы, который вы ввели')
        print('"!help" даёт совет по отгадке букв')
